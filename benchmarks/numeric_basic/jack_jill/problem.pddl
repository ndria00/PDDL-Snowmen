(define (problem jack_jill)
    ...
    (:init
        ...
        (= (smallest_ball_at loc_1_4) 3)
        (= (biggest_ball_at loc_1_4) 3)
        (= (balls_in_location loc_1_4) 1)
        ...
        (= (smallest_ball_at loc_1_2) 3)
        (= (biggest_ball_at loc_1_2) 3)
        (= (balls_in_location loc_1_2) 1)
