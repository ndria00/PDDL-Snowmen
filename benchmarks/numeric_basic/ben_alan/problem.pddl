(define (problem ben_alan)
    ...
    (:init
        ...
        (= (smallest_ball_at loc_4_5) 1)
        (= (biggest_ball_at loc_4_5) 1)
        (= (balls_in_location loc_4_5) 1)
        ...
        (= (smallest_ball_at loc_5_4) 1)
        (= (biggest_ball_at loc_5_4) 1)
        (= (balls_in_location loc_5_4) 1)
