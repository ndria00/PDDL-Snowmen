    ...
    (:action move_character
        ...
        :precondition 
            (and 
                ...
                (<= (balls_of_size_three) (snowmen_to_build))
            )
        :effect 
            (and 
                (character_at ?to)
    ...
    (:action move_ball
        ...
        :effect         
            (and
                ...
                ; increase number of balls of size three when a ball of size 2 rolls on a location with snow
                (when (and (snow ?to) (= (ball_size ?b) 2)) (and (increase (balls_of_size_three) 1)))
